...
public class TextureTilingController : MonoBehaviour {
  ...
  void UpdateTiling()
  {
    ...
    if (sharedMaterial == null || r.sharedMaterial != instantiatedMaterial) {
      sharedMaterial = r.sharedMaterial;
      texture = sharedMaterial.mainTexture;
    }
    ...
    Material tempMaterial = new Material(sharedMaterial);
    ...
    instantiatedMaterial = tempMaterial;
  }
}
